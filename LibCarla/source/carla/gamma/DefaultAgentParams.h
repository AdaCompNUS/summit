#ifndef DEFAULT_AGENT_PARAMS_H_
#define DEFAULT_AGENT_PARAMS_H_
...
struct AgentParams{
	...
	float neighborDist = 8.0f;
	int maxNeighbors = 5;
	float timeHorizon = 3.0f;
	float timeHorizonObst = 5.0f;
	float radius = 0.25f;
	float maxSpeed = 5.0f;
	RVO::Vector2 velocity = RVO::Vector2(0.0f, 0.0f);
	std::string tag = "People";
	float max_tracking_angle = 90.0f;
	float len_ref_to_front = 0.1f;
	float len_ref_to_side = 0.22f;
	float len_ref_to_back = 0.1f;
	float len_rear_axle_to_front_axle = 0.2f;
	float error_bound = 0.0f;
	float pref_speed = 1.2f;
	...
	static const AgentParams& getDefaultAgentParam(std::string tag){
		...
		static auto create_lookup = []() { //lambda function
			...
			AgentParams ped = {	ped_position, ped_neighborDist, ped_maxNeighbors, ped_timeHorizon, ped_timeHorizonObst, ped_radius, ped_maxSpeed, ped_velocity, ped_tag, 
			...
			AgentParams scooter = {	scooter_position, scooter_neighborDist, scooter_maxNeighbors, scooter_timeHorizon, scooter_timeHorizonObst, scooter_radius, scooter_maxSpeed, scooter_velocity, scooter_tag, 
			...
			AgentParams car = {	car_position, car_neighborDist, car_maxNeighbors, car_timeHorizon, car_timeHorizonObst, car_radius, car_maxSpeed, car_velocity, car_tag, 
			...
			AgentParams van = {	van_position, van_neighborDist, van_maxNeighbors, van_timeHorizon, van_timeHorizonObst, van_radius, van_maxSpeed, van_velocity, van_tag, 
			...
			AgentParams bus = {	bus_position, bus_neighborDist, bus_maxNeighbors, bus_timeHorizon, bus_timeHorizonObst, bus_radius, bus_maxSpeed, bus_velocity, bus_tag, 
			...
			AgentParams jeep = { jeep_position, jeep_neighborDist, jeep_maxNeighbors, jeep_timeHorizon, jeep_timeHorizonObst, jeep_radius, jeep_maxSpeed, jeep_velocity, jeep_tag, 
			...
			AgentParams bicycle = {	bicycle_position, bicycle_neighborDist, bicycle_maxNeighbors, bicycle_timeHorizon, bicycle_timeHorizonObst, bicycle_radius, bicycle_maxSpeed, bicycle_velocity, bicycle_tag, 
			...
			AgentParams electric_tricycle = {	electric_tricycle_position, electric_tricycle_neighborDist, electric_tricycle_maxNeighbors, electric_tricycle_timeHorizon, electric_tricycle_timeHorizonObst, electric_tricycle_radius, electric_tricycle_maxSpeed, electric_tricycle_velocity, electric_tricycle_tag, 
			...
			AgentParams gyro_scooter = {	gyro_scooter_position, gyro_scooter_neighborDist, gyro_scooter_maxNeighbors, gyro_scooter_timeHorizon, gyro_scooter_timeHorizonObst, gyro_scooter_radius, gyro_scooter_maxSpeed, gyro_scooter_velocity, gyro_scooter_tag, 
