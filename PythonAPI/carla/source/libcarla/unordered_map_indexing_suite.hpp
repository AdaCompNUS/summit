...
#ifndef UNORDERED_MAP_INDEXING_SUITE_HPP
# define UNORDERED_MAP_INDEXING_SUITE_HPP
...
namespace boost { namespace python {
    ...
    class unordered_map_indexing_suite;

    namespace detail
    {
        template <class Container, bool NoProxy>
        class final_map_derived_policies
            : public unordered_map_indexing_suite<Container,
    ...
    public:
        ...
        extension_def(Class& cl)
        {
            ...
            std::string elem_name = "unordered_map_indexing_suite_";
...
#endif // UNORDERED_MAP_INDEXING_SUITE_HPP
