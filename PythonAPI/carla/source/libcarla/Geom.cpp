...
void export_geom() {
  ...
  class_<std::vector<std::vector<std::vector<cg::Vector2D>>>>("vector_of_vector_of_vector_of_vector2D")
      .def(boost::python::vector_indexing_suite<std::vector<std::vector<std::vector<cg::Vector2D>>>>())
      .def(self_ns::str(self_ns::self))
  ;
